...
public class Hotel extends Alojamiento implements Comparable<Hotel>{
    ...
    protected float precio=50f;

    public Hotel() {
    }

    public Hotel(int cantHabitaciones, int nroCamas, int nroPisos, String nombre, String direccion, String localidad, String encargado) {
    ...
    public String toString() {
        return super.toString() + "Hotel{" + "cantHabitaciones=" + cantHabitaciones + ", nroCamas=" + nroCamas + ", nroPisos=" + nroPisos + ", precio=" + precio + '}';
    }

    @Override
    public int compareTo(Hotel t) {
        return Float.compare(t.precio,this.precio);
         }
