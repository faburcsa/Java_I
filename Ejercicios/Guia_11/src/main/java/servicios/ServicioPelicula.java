...
public class ServicioPelicula {
    ...
    public static void ordenarPeliculasDuracionMayorMenor(ArrayList<Pelicula> peliArray) {
        ...
        Collections.sort(peliArray, comparadores.xDuracionMayorMenor);
    }
    ...
    public static void ordenarPeliculasDuracionMenorMayor(ArrayList<Pelicula> peliArray) {
        ...
        Collections.sort(peliArray, comparadores.xDuracionMenorMayor);
    }
...
//     * • Ordenar las películas por título, alfabéticamente y mostrarlo en pantalla.
        ...
        Collections.sort(peliArray, comparadores.xTitulo);
    }
...
// * pantalla.
        ...
        Collections.sort(peliArray, comparadores.xDirector);
    }
