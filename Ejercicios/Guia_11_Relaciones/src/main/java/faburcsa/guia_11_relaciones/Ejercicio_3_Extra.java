 ...
 * transferencia, etc.). Debemos realizar el diagrama de clases completo,
 * teniendo en cuenta todos los requerimientos arriba descriptos. Modelando
 * clases con atributos y sus correspondientes
 */
